...
public class downloadNewVersion extends AppCompatActivity {
        ...
        btn_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkPermission()) {
                    ...
                    atualizaApp.setContext(downloadNewVersion.this);
                    atualizaApp.execute("https://staging.thornbills.com/app-debug.apk");
                } else {
                    requestPermission();
                }
            }
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            if (grantResults.length > 0) {
                ...
                if (locationAccepted && cameraAccepted) {
                    ...
                    updateApp.setContext(downloadNewVersion.this);
